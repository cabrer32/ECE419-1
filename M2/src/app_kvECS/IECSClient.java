...
public interface IECSClient {
     ...
     * same directory as the IECS. All storage servers are initialized with the metadata and any persisted data, and remain in state stopped.
    ...
    /**
     * Sets up `count` servers with the IECS (in this case Zookeeper)
